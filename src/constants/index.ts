...
export const IMPORT_PART_REQUEST = 'IMPORT_PART_REQUEST';
export const IMPORT_PART_SUCCESS = 'IMPORT_PART_SUCCESS';
export const IMPORT_PART_FAILED = 'IMPORT_PART_FAILED';
