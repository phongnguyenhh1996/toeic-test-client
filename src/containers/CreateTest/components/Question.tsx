...
const AnswerExam: any = styled.div`
    ...
    flex-grow: 1;
    border-radius: 10px;
    border: 1px solid ${(props: any) => props.$active ? theme.backgroundSecondary : theme.backgroundDarkSecondary};
    background-color: ${(props: any) => props.$active ? theme.backgroundPaginationBtn : 'transparent'};
...
export const Question: React.FC<QuestionProps> = ({ isExam = false, question, answers, correctAnswer, onClick, currentQuestionNumb }) => {
                ...
                <Content>
                    ...
                    {Object.values(answers).map(answer => (
                        <AnswerWrapper key={answer.answerNumb}>
                            ...
                            />
                            <AnswerExam $active={correctAnswer.answerNumb === answer.answerNumb}>
